...
//Función que da formato a la fecha y regresa los datos como necesitamos
...
//funcion que nos da el nombre en español del mes.
...
//***** función para sumar 2 valures*****
//puede usarse en forma recursiva
function suma($dato1, $dato2)
{
	return $dato1 + $dato2;
}
//***** fin función para sumar 2 valures*****


//***** función para restar 2 valures*****
//puede usarse en forma recursiva
function resta($dato1, $dato2)
{
	return $dato1 - $dato2;
}
//***** fin función para restar 2 valures*****


//***** función para multiplicar 2 valures*****
//puede usarse en forma recursiva
...
//***** fin función para multiplicar 2 valures*****


//***** función para dividir 2 valures*****
//puede usarse en forma recursiva
...
//***** función para escribir datos corridos en los recibos dentro del pdf *****
//puede usarse en forma recursiva
...
//$ojb= es el objeto $pdf que será usado para realizar la impresión de $cadena
...
//***** fin función para escribir datos corridos *****




//************************* Numero a letras ********************************************
//Función que convierte numeros en letra para el estandar mexicano
//destinado a ser escrito para facturas que funciona en forma recursiva
//-----------------------------------------------------------------------------------
//---------------  Función principal ----------------------------------------------
//su capasidad maxima de converción es 999,999,999,999.99 si se requiere algo mayor
//será necesario agreagr la función de billones, trillones, cuatrillones, etc.
//esta función recibe un numero doble con o sin decimales
