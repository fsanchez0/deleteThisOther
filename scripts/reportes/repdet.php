...
if($misesion->verifica_sesion()=="yes")
{
	...
	$sql = "select idhistoria, fechapago,fechagenerado, fechanaturalpago, fechavencimiento,tipocobro, historia.cantidad as cantidadh, historia.iva as ivah, historia.interes as inth, nombre, nombre2, apaterno, amaterno, calle, numeroint, numeroext, contrato.idcontrato as idcont from historia,contrato, inquilino, inmueble, cobros, tipocobro where historia.idcobros = cobros.idcobros and historia.idcontrato= contrato.idcontrato and contrato.idinquilino=inquilino.idinquilino and contrato.idinmueble = inmueble.idinmueble and cobros.idtipocobro = tipocobro.idtipocobro and contrato.litigio = false ";
	...
	if($fechai && $fechaf)
	{
		...
		{
			//echo "Pagados ";
			$sql .= " and historia.aplicado=true and fechapago between '" . $fechai . "' and '" . $fechaf . "' order by fechapago, contrato.idcontrato, idhistoria";
		...
		{
			//echo "Por pagar";
			$sql .= " and historia.aplicado=false and fechavencimiento between '" . $fechai . "' and '" . $fechaf . "' order by fechavencimiento, contrato.idcontrato, idhistoria ";
				...
				while($row = mysql_fetch_array($operacion))
				{
					...
					if ($filtro=="1")
					{
						...
						if($primer!=$row["fechapago"])
						{
							...
							$color="";
							$vcontrato = $row["idcont"];

						}

						if ($vcontrato != $row["idcont"])
						{
							$vcontrato = $row["idcont"];
							if($color=="")
							{
						...
						$reporte .= "<tr $color><td>" . $row["idcont"] . "</td><td>" . $row["nombre"] . " "  . $row["nombre2"] . " " . $row["apaterno"] . " " . $row["amaterno"]  . "</td><td>" . $row["calle"] . " " .$row["numeroext"] . " " . $row["numeroint"] . "</td><td>" . $row["fechanaturalpago"] . "</td><td>" . $concepto . "</td><td align=\"right\">$ " . number_format(($row["cantidadh"] ),2) . "</td></tr>";
						$sumap += ($row["cantidadh"] );
						$sumag += ($row["cantidadh"] );
/*						
...
*/
					...
					else
					{
						...
						//$reporte .= "<tr $color><td>" . $row["idcont"] . "</td><td>" . $row["nombre"] . " "  . $row["nombre2"] . " " . $row["apaterno"] . " " . $row["amaterno"]  . "</td><td>" . $row["calle"] . " " .$row["numeroext"] . " " . $row["numeroint"] . "</td><td>" . $row["fechanaturalpago"] . "</td><td>" . $concepto . "</td><td align=\"right\">$ " . number_format(($row["cantidadh"] + $row["ivah"]) ,2) . "</td></tr>";
						$reporte .= "<tr $color><td>" . $row["idcont"] . "</td><td>" . $row["nombre"] . " "  . $row["nombre2"] . " " . $row["apaterno"] . " " . $row["amaterno"]  . "</td><td>" . $row["calle"] . " " .$row["numeroext"] . " " . $row["numeroint"] . "</td><td>" . $row["fechanaturalpago"] . "</td><td>" . $concepto . "</td><td align=\"right\">$ " . number_format(($row["cantidadh"]) ,2) . "</td></tr>";
						$sumap += ($row["cantidadh"] + $row["ivah"]);
						$sumag += ($row["cantidadh"] + $row["ivah"]);
					}
			...
			else
			{
				...
				while($row = mysql_fetch_array($operacion))
				{
					...
					if ($filtro=="1")
					{
						...
						$reporte .= "<tr $color><td>" . $row["idcont"] . "</td><td>" . $row["nombre"] . " "  . $row["nombre2"] . " " . $row["apaterno"] . " " . $row["amaterno"]  . "</td><td>" . $row["calle"] . " " .$row["numeroext"] . " " . $row["numeroint"] . "</td><td>" . substr($row["fechapago"],8,2) . "</td><td>" . $row["fechanaturalpago"] . "</td><td>" . $concepto . "</td><td align=\"right\">$ " . number_format(($row["cantidadh"] ) ,2) . "</td></tr>";
						$sumap += ($row["cantidadh"] );
						$sumag += ($row["cantidadh"] );						
...
*/
					...
					else
					{
						...
						//$reporte .= "<tr $color><td>" . $row["idcont"] . "</td><td>" . $row["nombre"] . " "  . $row["nombre2"] . " " . $row["apaterno"] . " " . $row["amaterno"]  . "</td><td>" . $row["calle"] . " " .$row["numeroext"] . " " . $row["numeroint"] . "</td><td>" . substr($row["fechavencimiento"],8,2) . "</td><td>" . $row["fechanaturalpago"] . "</td><td>" . $concepto . "</td><td align=\"right\">$ " . number_format(($row["cantidadh"] + $row["ivah"]) ,2) . "</td></tr>";
						$reporte .= "<tr $color><td>" . $row["idcont"] . "</td><td>" . $row["nombre"] . " "  . $row["nombre2"] . " " . $row["apaterno"] . " " . $row["amaterno"]  . "</td><td>" . $row["calle"] . " " .$row["numeroext"] . " " . $row["numeroint"] . "</td><td>" . substr($row["fechavencimiento"],8,2) . "</td><td>" . $row["fechanaturalpago"] . "</td><td>" . $concepto . "</td><td align=\"right\">$ " . number_format(($row["cantidadh"] ) ,2) . "</td></tr>";
						$sumap += ($row["cantidadh"] + $row["ivah"]);
						$sumag += ($row["cantidadh"] + $row["ivah"]);
					}
		...
		else
		{
			...
			while($row = mysql_fetch_array($operacion))
			{
				if ($filtro=="1")   //pagados
				{
					...
					$reporte .= "<tr $color><td>" . $row["idcont"] . "</td><td>" . $row["nombre"] . " "  . $row["nombre2"] . " " . $row["apaterno"] . " " . $row["amaterno"]  . "</td><td>" . $row["calle"] . " " .$row["numeroext"] . " " . $row["numeroint"] . "</td><td>" . $row["fechapago"] . "</td><td>" . $row["fechanaturalpago"] . "</td><td>" . $concepto . "</td><td align=\"right\">$ " . number_format(($row["cantidadh"] ),2) . "</td></tr>";					
					$sumag += ($row["cantidadh"]);
/*					
...
*/
				...
				else
				{
					...
					//$reporte .= "<tr $color><td>" . $row["idcont"] . "</td><td>" . $row["nombre"] . " "  . $row["nombre2"] . " " . $row["apaterno"] . " " . $row["amaterno"]  . "</td><td>" . $row["calle"] . " " .$row["numeroext"] . " " . $row["numeroint"] . "</td><td>" . $row["fechavencimiento"] . "</td><td>" . $row["fechanaturalpago"] . "</td><td>" . $concepto . "</td><td align=\"right\">$ " . number_format(($row["cantidadh"] + $row["ivah"]),2) . "</td></tr>";
					$reporte .= "<tr $color><td>" . $row["idcont"] . "</td><td>" . $row["nombre"] . " "  . $row["nombre2"] . " " . $row["apaterno"] . " " . $row["amaterno"]  . "</td><td>" . $row["calle"] . " " .$row["numeroext"] . " " . $row["numeroint"] . "</td><td>" . $row["fechavencimiento"] . "</td><td>" . $row["fechanaturalpago"] . "</td><td>" . $concepto . "</td><td align=\"right\">$ " . number_format(($row["cantidadh"] ),2) . "</td></tr>";
					$sumag += ($row["cantidadh"] + $row["ivah"]);
				}
			}
			$reporte .= "</table>\n";
