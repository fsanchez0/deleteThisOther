...
if($_REQUEST["descargar"]==true)
{
	...
	while($row = mysql_fetch_array($resultado)){	
        ...
        $sqlref = "select * from apartado where idapartado = " . $row["idapartado"];
        $resultadoref= mysql_query($sqlref);
...
else 
{
	...
	$html .= "<div id=\"content\">  <div id=\"head\"><img src=\"imagenes/headp.jpg\" width=\"612\" height=\"134\" alt=\"Padilla Bujalil. Pendientes por pagar\" /><div id=\"tablas\"><h1 style=\"$h1\">Pendientes de Inmuebles por cobrar </h1>\n";
	...
	while($row = mysql_fetch_array($operacion))
	{
		...
		if($ccontrato!=$row["elidcontrato"])
		{
			...
			$Cabeceratabla .="<tr style=\"$cfondo\"><th>Referencia: </th><td colspan=\"3\">" . $referencia  . "</td></tr>";
...
<form action='/scripts/reportes/pendientesp.php' method='post'>
 <input type='hidden' name='descargar' value=true><br>
