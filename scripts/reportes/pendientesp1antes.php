...
$hoy2=date('Y-m-d');
	...
	$html .= "<div id=\"content\">  <div id=\"head\"><img src=\"imagenes/head.jpg\" width=\"612\" height=\"134\" alt=\"Padilla Bujalil. Pendientes por pagar\" /><div id=\"tablas\"><h1>Pendientes de Inmuebles por cobrar 0 a 60 días</h1>\n";
	...
	while($row = mysql_fetch_array($operacion))
	{
		...
		if($ccontrato!=$row["elidcontrato"])
		{
			...
			$filad=$gris;
			$pendiente="window.open( '$ruta/pendientec1.php?contrato=" . $row["elidcontrato"] . "');";
