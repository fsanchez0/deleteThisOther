...
if($misesion->verifica_sesion()=="yes")
{
	...
	if($reporte->paraenviar==1)
	{
		...
		//$esok=$enviocorreo->enviar("contabilidad@padilla-bujalil.com.mx", "Envio de estado de cuenta", $mensaje, $edocuenta, $facturas);
		//echo "enviando: Envio de estado de cuenta $periodo - $dueniona";
		$esok=$enviocorreo->enviar($correoe, "Envio de estado de cuenta $periodo - $dueniona", $mensaje, $edocuenta, $facturas);
		...
		//$esok=$enviocorreo->enviar($para, "Envio de estado de cuenta", $mensaje, 'reporte_0.pdf', $facturas);
	}
