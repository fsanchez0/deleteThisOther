...
<!--
		...
		<input type="button" value="$boton2" name="agregar" onClick="if(descripcion.value!=''  && total.value!='' ){   cargarSeccion('$dirscript','contenido','accion=' + accion.value + '&paso=0&id=' + ids.value + '&idcontrato=$idcontrato&idinmueble=$idinmueble&iva=' + iva.value  + '&utilidad=' + util.value  + '&iva=' + iva.value + '&total=' + total.value + '&descripcion=' + descripcion.value+ '&facturar=' + facturar.checked  )};" >
-->		
		<input type="button" value="$boton2" name="agregar" onClick="if(descripcion.value!=''  && total.value!='' ){  window.open('$ruta/imprimircargoduenio.php?accion=' + accion.value + '&paso=0&id=' + ids.value + '&idcontrato=$idcontrato&idinmueble=$idinmueble&iva=' + iva.value  + '&utilidad=' + util.value  + '&iva=' + iva.value + '&total=' + total.value + '&descripcion=' + descripcion.value+ '&facturar=' + facturar.checked,'_blank'  ); document.getElementById('cargod').reset();cargarSeccion('$dirscript','contenido','');this.disabled=true;};" >
		<input type="hidden" name="ids" value="$id">
		<input type="hidden" name="accion" value="$accion">
		<input type="hidden" name="privagregar" value="$priv[1]">
		<input type="hidden" name="priveditar" value ="$priv[2]">
		<br>Nota: El cargo sera aplicado directa al inmueble.
