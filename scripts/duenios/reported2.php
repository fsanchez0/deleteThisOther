...
//enviar ahora a todos los correos que tengan los dueños
		...
		//Cambio 16/06/21 Se cambio la funcion para enviar el reporte de los propietarios
		// $esok=$enviocorreo->enviar($correoe, "Envio de estado de cuenta $periodo - $dueniona", $mensaje, $edocuenta, $facturas,$idedoduenioss);
		$esok=$enviocorreo->enviarFromPadilla($correoe, "Envio de estado de cuenta $periodo - $dueniona", $mensaje, $edocuenta, $facturas,$idedoduenioss);
		if($esok)
		{
