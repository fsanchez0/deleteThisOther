...
if($misesion->verifica_sesion()=="yes")
{
	...
	case 4: //duenio
		...
		$sql2 = "select *, d.idduenio as idd, indu.idinmueble as idin, d.nombre as nombred, d.nombre2 as nombre2d, d.apaterno as apaternod, d.amaterno as amaternod  from  inmueble, duenioinmueble indu, duenio d where indu.idinmueble = inmueble.idinmueble and indu.idduenio = d.idduenio  and ( d.nombre  like '%$dato%' or d.nombre2  like '%$dato%' or d.apaterno like '%$dato%' or d.amaterno like '%$dato%') ";
	}
	//echo $sql;
