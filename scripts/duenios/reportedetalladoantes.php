...
*/
	...
	$sql = "select d.idduenio as idd, nombre, nombre2, apaterno, amaterno from duenio d, duenioinmueble di, inmueble i where d.idduenio = di.idduenio and di.idinmueble = i.idinmueble   group by d.idduenio, nombre, nombre2, apaterno, amaterno";
	$periodo = date("Y-m-d");	
	$operacion = mysql_query($sql);
