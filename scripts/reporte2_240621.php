...
case 2://due–os 
	...
	$sql = "select * From cfdiedoduenio df, cfdipartidas pf, edoduenio e where df.idcfdiedoduenio = pf.idcfdiedoduenio and pf.idedoduenio = e.idedoduenio and df.idcfdiedoduenio = $id ";
...
default: //arrendamiento (inmuebles)
    ...
    //verificar si el retulstado es un arreglo de 2 con sepraración de "|", y que ademas que las ultimas 3 letras de 0 sean pdf y las e 1 sean xml
    //eso dignifica que fue exitoso y son los nombres de los archivos que envíarán por correo buzón que se indico en el formulario.
