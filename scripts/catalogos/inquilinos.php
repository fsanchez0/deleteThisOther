...
<tr>
	...
	<td>Fecha de nacimiento o Fecha de Constitucion:</td>

	<td><input type="date" name="fechanacimiento" id="fechanacimiento" value="$fechanacimiento" $isDisabled></td>
...
<tr>
	<td colspan="2" align="center">
		...
		<input type="button" value="$boton2" $isDisabled name="agregar" onClick="acccionInquilinos(this)" >
