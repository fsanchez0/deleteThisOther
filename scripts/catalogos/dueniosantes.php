...
if($estadod==null){$estadod="Distrito Federal";};
if($paisp==null){$paisp="MEXICO";};
if($estadop==null){$estadop="Distrito Federal";};
...
formulario1;
	...
	$datos=mysql_query($sql);
	echo "<div name=\"busquedacobro\" id=\"busquedacobro\" class=\"scroll\">";
	echo "<table border=\"1\"><tr><th>Id</th><th>Nombre</th><th>Segundo Nombre</th><th>A. Paterno</th><th>A. Materno</th><th>RFC</th><th>Tel&eacute;fono</th><th>C.P.</th><th>Usuario</th><th>Acciones</th></tr>";
	while($row = mysql_fetch_array($datos))
	{
