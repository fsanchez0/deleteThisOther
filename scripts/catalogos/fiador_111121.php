...
if($misesion->verifica_sesion()=="yes")
{
	...
	if($aud->id!=0)
	{
		$btnaud = "<input type='button' value='Imprimir movimiento' $isDisabled onClick=\"window.open('$ruta/impresiontransaccion.php?id=$aud->id&seccion=fiador');\">";
...
<tr>
	<td>RFC</td>
	<td><input type="text" name="rfc" id="rfc" value="$rfc" $isDisabled></td>
</tr>

<tr>
	<td>Identificacion:</td>
	<td><input type="text" name="identificacion" value="$identificacion" $isDisabled></td>
</tr>
<tr>
	<td>Direcci&oacute;n:</td>
	<td><textarea name="direccion" cols="30" rows="5" $isDisabled>$direccion</textarea></td>
</tr>
<tr>
...
<tr>
	...
	<td><textarea name="datosinmueble" cols="30" rows="5" $isDisabled>$datosinmueble</textarea></td>
</tr>
<tr>
...
<tr>
	<td>e-mail:</td>
	<td><input type="text" name="emailf" value="$emailf" $isDisabled></td>
</tr>
<tr>
...
//		echo "<tr><td>" . $row["idfiador"] . "</td><td>" . $row["nombre"] . "</td><td>" . $row["nombre2"] . "</td><td>" . $row["apaterno"] . "</td><td>" . $row["amaterno"] . "</td><td>" . $row["identificacion"] . "</td><td>" . $row["direccion"] . "</td><td>" . $row["datosinmueble"] . "</td><td>" . $row["tel"] . "</td><td>";
		...
		$html .= "<input type=\"button\" value=\"Ver\" onClick=\"cargarSeccion('$dirscript','contenido','accion=6&id=" .  $row["idfiador"]  . "' )\" $txteditar>";
