...
if($misesion->verifica_sesion()=="yes")
{
	...
	$html = "<center><h2>Faturacion Masiva</h2><br>
		...
		<br>
		<input type='button' value='Deseleccionar todo' onclick=\"checks = document.querySelectorAll('input[type=\'checkbox\']'); checks.forEach( e => { e.checked = false; actualizamailsp(e.name,0)});\" />
		<br>
		<table border='1'>
