...
//insert del ingreso del duenio
		...
		if($tipocobrto=="DEPOSITO")
			$sqling .= "($idd ,$idcon, $idinm, $idtc , $idhist , '$fechaedod' , '$horaedod', $impedo0 , false, false, 'h_$idhist' , '" . $notas . "DEPOSITO en garantia' ,0, false  )";
		else
...
//insert del cobro de honorario
		...
		if($tipocobrto=="DEPOSITO")
			$sqlhon .= "($idd ,$idcon, $idinm , $idtc , $idhist , '$fechaedod' , '$horaedod', $hon , false, false, 'h_$idhist' , 'Honorario (" . $pcomicion . "% mas 16% I.V.A) por corretaje de inmueble',$ivah, false  )";
		else
			$sqlhon .= "($idd ,$idcon, $idinm , $idtc , $idhist , '$fechaedod' , '$horaedod', $hon , false, false, 'h_$idhist' , 'Honorario (" . $pcomicion . "% mas 16% I.V.A) de administracion $tipocobrto $mes',$ivah, false  )";
