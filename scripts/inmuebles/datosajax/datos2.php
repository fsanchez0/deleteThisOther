...
$servicios=$_GET["servicio"];
$_SESSION["contrato"]=$contrato;
//header("Location: editplace.php?contrato=$contrato"); 
?>
<!DOCTYPE html>
...
<body>
	...
	<div class="table table-responsive">
		...
		<input type="hidden" name="servicio" id="servicio" value="<?php echo $servicios; ?>">
	...
	$(document).ready(function() 
	{
		...
		$.ajax({
			type: "GET",
			url: "editplace2.php?tabla=1&idcontrato="+ contra+"&servicio="+service,
		})
		.done(function(json) {
			json = $.parseJSON(json)
