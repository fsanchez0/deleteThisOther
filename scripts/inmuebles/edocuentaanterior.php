...
if ($accion){
	...
	//$sql= "SELECT contrato.idcontrato as elidcontrato, inquilino.nombre, inquilino.nombre2, inquilino.apaterno, inquilino.amaterno, inquilino.tel as telinq,tipocobro, historia.fechagenerado, historia.fechanaturalpago, historia.fechagracia, historia.fechapago, historia.cantidad, aplicado, historia.interes, vencido,inmueble.calle, inmueble.numeroext, inmueble.numeroint, inmueble.colonia, inmueble.delmun, inmueble.cp, estado, pais, inmueble.tel as telinm, historia.iva as ivah,aplicado, condonado, fiador.nombre as fnombre, fiador.nombre2 as fnombre2, fiador.apaterno as fapaterno, fiador.amaterno as famaterno, fiador.direccion as fdireccion, fiador.tel as ftel, historia.notas as hnotas, fiador.email as emailf, notanc, inquilino.email as emaili, observaciones FROM contrato, cobros, inquilino, inmueble, tipocobro,historia, fiador, estado, pais WHERE cobros.idtipocobro=tipocobro.idtipocobro and contrato.idcontrato=historia.idcontrato and historia.idcobros=cobros.idcobros and contrato.idinquilino=inquilino.idinquilino and contrato.idinmueble=inmueble.idinmueble and contrato.idcontrato = $accion and contrato.idfiador=fiador.idfiador and inmueble.idestado = estado.idestado and inmueble.idpais = pais.idpais order by fechanaturalpago, tipocobro,interes,fechagenerado,fechapago, aplicado";
	 $sql= "SELECT contrato.idcontrato as elidcontrato, inquilino.nombre, inquilino.nombre2, inquilino.apaterno, inquilino.amaterno, inquilino.tel as telinq,tipocobro, historia.fechagenerado, historia.fechanaturalpago, historia.fechagracia, historia.fechapago, historia.cantidad, aplicado, historia.interes, vencido,inmueble.calle, inmueble.numeroext, inmueble.numeroint, inmueble.colonia, inmueble.delmun, inmueble.cp, estado, pais, inmueble.tel as telinm, historia.iva as ivah,aplicado, condonado, fiador.nombre as fnombre, fiador.nombre2 as fnombre2, fiador.apaterno as fapaterno, fiador.amaterno as famaterno, fiador.direccion as fdireccion, fiador.tel as ftel, historia.notas as hnotas, fiador.email as emailf, notanc, inquilino.email as emaili, observaciones, archivotxt, archivopdf,archivoxml,archivopdfn,txtok,pdfok,xmlok,pdfnok, historia.idhistoria as idh, hfacturacfdi,inmueble.idinmueble as idinm FROM contrato, cobros, inquilino, inmueble, tipocobro,historia, fiador, estado, pais WHERE cobros.idtipocobro=tipocobro.idtipocobro and contrato.idcontrato=historia.idcontrato and historia.idcobros=cobros.idcobros and contrato.idinquilino=inquilino.idinquilino and contrato.idinmueble=inmueble.idinmueble and contrato.idcontrato = $accion and contrato.idfiador=fiador.idfiador and inmueble.idestado = estado.idestado and inmueble.idpais = pais.idpais order by fechanaturalpago, tipocobro,interes,fechagenerado,fechapago, aplicado";
...
$users=mysql_query("SELECT * FROM privilegiofile WHERE idusuario='$usuarios' AND ver='1'");
	...
	if ($totalreg==1) {
		$botonluz="<iframe src=\"http://192.168.1.250/scripts/inmuebles/cargaPDF.php?idcontrato=".$accion."+&servicio=luz\" style=\"border:0px; height:45px;width:600px;\"></iframe><button type=\"button\" id=\"btnluz\" class=\"btn btn-success btn-sm \" data-toggle=\"modal\" data-target=\"#myModal\">Agregar</button>&nbsp;<button type=\"button\" class=\"btn btn-success btn-sm \" id=\"btnluz2\" data-toggle=\"modal\" data-target=\"#myModal2\">Ver Servicios</button>";
		$botonagua="<iframe src=\"http://192.168.1.250/scripts/inmuebles/cargaPDF.php?idcontrato=".$accion."+&servicio=agua\" style=\"border:0px; height:45px;width:600px;\"></iframe><button type=\"button\" id=\"btnagua\" class=\"btn btn-success btn-sm \" data-toggle=\"modal\" data-target=\"#myModal\">Agregar</button>";
		$botongas="<iframe src=\"http://192.168.1.250/scripts/inmuebles/cargaPDF.php?idcontrato=".$accion."+&servicio=gas\" style=\"border:0px; height:45px;width:600px;\"></iframe><button type=\"button\" id=\"btngas\" class=\"btn btn-success btn-sm \" data-toggle=\"modal\" data-target=\"#myModal\">Agregar</button>";
		$botoncondominio="<iframe src=\"http://192.168.1.250/scripts/inmuebles/cargaPDF.php?idcontrato=".$accion."+&servicio=condominio\" style=\"border:0px; height:45px;width:600px;\"></iframe><button type=\"button\" id=\"btncondominio\" class=\"btn btn-success btn-sm \" data-toggle=\"modal\" data-target=\"#myModal\">Agregar</button>";
		$botonpredial="<iframe src=\"http://192.168.1.250/scripts/inmuebles/cargaPDF.php?idcontrato=".$accion."+&servicio=predial\" style=\"border:0px; height:45px;width:600px;\"></iframe><button type=\"button\" id=\"btnpredial\" class=\"btn btn-success btn-sm \" data-toggle=\"modal\" data-target=\"#myModal\">Agregar</button>";
	}
	else{
		$botonluz="";
		$botonagua="";
	...
	$cabecera .= "<tr><td class='Cabecera'  width='180'>Servicio de Luz</td><td width='180'>" . $servicioluz. "</td><td>$botonluz</td><td><a href='http://192.168.1.250/scripts/inmuebles/contratos/$accion/luz.pdf' target='_blank'><img src='images/icon_pdf.png' width='80'></a></td></tr>";
	$cabecera .= "<tr><td class='Cabecera'>Servicio de Agua</td><td> " . $servicioagua . "</td><td>$botonagua</td><td><a href='http://192.168.1.250/scripts/inmuebles/contratos/$accion/agua.pdf' target='_blank'><img src='images/icon_pdf.png' width='80'></a></td></tr>";
	$cabecera .= "<tr><td class='Cabecera'>Servicio de Gas</td><td> " . $serviciogas . "</td><td>$botongas</td><td><a href='http://192.168.1.250/scripts/inmuebles/contratos/$accion/gas.pdf' target='_blank'><img src='images/icon_pdf.png' width='80'></a></td></tr>";
	$cabecera .= "<tr><td class='Cabecera'>Pagos de Condominio</td><td> " . $serviciocondominio. "</td><td>$botoncondominio</td><td><a href='http://192.168.1.250/scripts/inmuebles/contratos/$accion/condominio.pdf' target='_blank'><img src='images/icon_pdf.png' width='80'></a></td></tr>";
	$cabecera .= "<tr><td class='Cabecera'>Cuenta Predial</td><td> " .$cuentapredial . "</td><td>$botonpredial</td><td><a href='http://192.168.1.250/scripts/inmuebles/contratos/$accion/predial.pdf' target='_blank'><img src='images/icon_pdf.png' width='80'></a></td></tr>";
...
<div id="myModal2" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <iframe src="datosajax/datos.php?idcontrato=<?php echo $accion;?>" width="100%" height="400" style="border:0px;"></iframe>
    ...
    <div class="modal-content">
      ...
      <div class="form-group">
           ...
           <div class="form-group">
            ...
            <input type="text" class="form-control" id="estatus0" name="estatus" required maxlength="30" value=""> 
          </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
...
<script type="text/javascript">
	function guardar(){
		...
		var monto=document.getElementById("monto0").value;
