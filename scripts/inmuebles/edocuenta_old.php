...
{ 
    ...
    $carpeta = "contratos/$accion/pdf/";   
         if (!file_exists($carpeta)) {
         	mkdir("contratos/",0755);
         	mkdir("contratos/$accion/",0755);
         	mkdir("contratos/$accion/pdf/",0755);
			}	
		...
		rename($nombre_archivo, $nuevo_nombre);
            ...
            {   
                echo "El fichero ha sido copiado con éxito. <br />";   
            } else {   
...
$directorio = opendir("contratos/$accion/pdf/"); //ruta actual
while ($archivo1 = readdir($directorio)) //obtenemos un archivo y luego otro sucesivamente
{
    ...
    {
         $documentos.="- <a href='contratos/$accion/pdf/".$archivo1."' target='_bank'> ".$archivo1."</a><br />";
    }
...
/*  fin subir pdf */	
	...
	//if($usuarios==19||$usuarios==1||$usuarios==53||$usuarios==60){														
	if($usuarios==19||$usuarios==1||$usuarios==53||$usuarios==60||$usuarios==13||$usuarios==14||$usuarios==15||$usuarios==62||$usuarios==63||$usuarios==51||$usuarios==50||$usuarios==63||$usuarios==14||$usuarios==64||$usuarios==67||$usuarios==68){														
		$hi=" <span align='center' class='col-sm-4 download'><br>
	        <button class='btn btn-success btn-sm' id='from' name='from' value='".$accion."'
		...
		$botonexcel="<iframe src=\"$servidor/scripts/inmuebles/descargarEdoCuenta.php?idContrato=".$accion." style=\"border:0px; height:45px;width:600px;\"></iframe><button type=\"button\" id=\"btnexcel\" class=\"btn btn-success btn-sm \" data-toggle=\"modal\" data-target=\"#myModal\">Descargar Estado de Cuenta
		</button>";	
	}
	...
	//$sql= "SELECT contrato.idcontrato as elidcontrato, inquilino.nombre, inquilino.nombre2, inquilino.apaterno, inquilino.amaterno, inquilino.tel as telinq,tipocobro, historia.fechagenerado, historia.fechanaturalpago, historia.fechagracia, historia.fechapago, historia.cantidad, aplicado, historia.interes, vencido,inmueble.calle, inmueble.numeroext, inmueble.numeroint, inmueble.colonia, inmueble.delmun, inmueble.cp, estado, pais, inmueble.tel as telinm, historia.iva as ivah,aplicado, condonado, fiador.nombre as fnombre, fiador.nombre2 as fnombre2, fiador.apaterno as fapaterno, fiador.amaterno as famaterno, fiador.direccion as fdireccion, fiador.tel as ftel, historia.notas as hnotas, fiador.email as emailf, notanc, inquilino.email as emaili, observaciones FROM contrato, cobros, inquilino, inmueble, tipocobro,historia, fiador, estado, pais WHERE cobros.idtipocobro=tipocobro.idtipocobro and contrato.idcontrato=historia.idcontrato and historia.idcobros=cobros.idcobros and contrato.idinquilino=inquilino.idinquilino and contrato.idinmueble=inmueble.idinmueble and contrato.idcontrato = $accion and contrato.idfiador=fiador.idfiador and inmueble.idestado = estado.idestado and inmueble.idpais = pais.idpais order by fechanaturalpago, tipocobro,interes,fechagenerado,fechapago, aplicado";
	 //$sql= "SELECT contrato.idcontrato as elidcontrato, inquilino.nombre, inquilino.nombre2, inquilino.apaterno, inquilino.amaterno, inquilino.tel as telinq,tipocobro, historia.fechagenerado, historia.fechanaturalpago, historia.fechagracia, historia.fechapago, historia.cantidad, aplicado, historia.interes, vencido,inmueble.calle, inmueble.numeroext, inmueble.numeroint, inmueble.colonia, inmueble.delmun, inmueble.cp, estado, pais, inmueble.tel as telinm, historia.iva as ivah,aplicado, condonado, fiador.nombre as fnombre, fiador.nombre2 as fnombre2, fiador.apaterno as fapaterno, fiador.amaterno as famaterno, fiador.direccion as fdireccion, fiador.tel as ftel, historia.notas as hnotas, fiador.email as emailf, notanc, inquilino.email as emaili, observaciones, archivotxt, archivopdf,archivoxml,archivopdfn,txtok,pdfok,xmlok,pdfnok, historia.idhistoria as idh, hfacturacfdi,inmueble.idinmueble as idinm, aprobado, inquilino.tipofactura FROM contrato, cobros, inquilino, inmueble, tipocobro,historia, fiador, estado, pais WHERE cobros.idtipocobro=tipocobro.idtipocobro and contrato.idcontrato=historia.idcontrato and historia.idcobros=cobros.idcobros and contrato.idinquilino=inquilino.idinquilino and contrato.idinmueble=inmueble.idinmueble and contrato.idcontrato = $accion and contrato.idfiador=fiador.idfiador and inmueble.idestado = estado.idestado and inmueble.idpais = pais.idpais order by fechanaturalpago, tipocobro,interes,fechagenerado,fechapago, aplicado";
	 $sql= "SELECT contrato.idcontrato as elidcontrato, contrato.observacionesc, inquilino.nombre, inquilino.nombre2, inquilino.apaterno, inquilino.amaterno, inquilino.tel as telinq,tipocobro, historia.fechagenerado, historia.fechanaturalpago, historia.fechagracia, historia.fechapago, historia.cantidad, aplicado, historia.interes, vencido,inmueble.calle, inmueble.numeroext, inmueble.numeroint, inmueble.colonia, inmueble.delmun, inmueble.cp, estado, pais, inmueble.tel as telinm, historia.iva as ivah,aplicado, condonado, fiador.nombre as fnombre, fiador.nombre2 as fnombre2, fiador.apaterno as fapaterno, fiador.amaterno as famaterno, fiador.direccion as fdireccion, fiador.tel as ftel, historia.notas as hnotas, fiador.email as emailf, notanc, inquilino.email as emaili, observaciones, archivotxt, archivopdf,archivoxml,archivopdfn,txtok,pdfok,xmlok,pdfnok, historia.idhistoria as idh, hfacturacfdi,inmueble.idinmueble as idinm, aprobado, inquilino.tipofactura, historia.idcategoriat as idct  FROM contrato, cobros, inquilino, inmueble, tipocobro,historia, fiador, estado, pais WHERE cobros.idtipocobro=tipocobro.idtipocobro and contrato.idcontrato=historia.idcontrato and historia.idcobros=cobros.idcobros and contrato.idinquilino=inquilino.idinquilino and contrato.idinmueble=inmueble.idinmueble and contrato.idcontrato = $accion and contrato.idfiador=fiador.idfiador and inmueble.idestado = estado.idestado and inmueble.idpais = pais.idpais order by fechanaturalpago, tipocobro,interes,fechagenerado,fechapago, aplicado";
	...
	while ($row = mysql_fetch_array($result))
	{
		...
		if($Datos==0)
		{
			...
			$cabecera .= "<tr><td class='Cabecera'>Inquilino</td><td colspan='3'>" .  $row["nombre"] . " " . $row["nombre2"] . " " . $row["apaterno"] . " " . $row["amaterno"] . "(Tels. " . $row["telinq"] . ", " . $row["telinm"] . " email: " . $row["emaili"] . ")</td></tr>\n";
...
//****************************************	
	...
	$cabecera .= "<tr><td class='Cabecera'  width='180'>Servicio de Luz</td><td width='180'>" . $servicioluz. "</td><td>$botonluz</td><td><a href='$servidor/scripts/inmuebles/contratos/$accion/luz.pdf' target='_blank'><img src='images/icon_pdf.png' width='80'></a></td></tr>";
	$cabecera .= "<tr><td class='Cabecera'>Servicio de Agua</td><td> " . $servicioagua . "</td><td>$botonagua</td><td><a href='$servidor/scripts/inmuebles/contratos/$accion/agua.pdf' target='_blank'><img src='images/icon_pdf.png' width='80'></a></td></tr>";
	$cabecera .= "<tr><td class='Cabecera'>Servicio de Gas</td><td> " . $serviciogas . "</td><td>$botongas</td><td><a href='$servidor/scripts/inmuebles/contratos/$accion/gas.pdf' target='_blank'><img src='images/icon_pdf.png' width='80'></a></td></tr>";
	$cabecera .= "<tr><td class='Cabecera'>Pagos de Condominio</td><td> " . $serviciocondominio. "</td><td>$botoncondominio</td><td><a href='$servidor/scripts/inmuebles/contratos/$accion/condominio.pdf' target='_blank'><img src='images/icon_pdf.png' width='80'></a></td></tr>";
	$cabecera .= "<tr><td class='Cabecera'>Cuenta Predial</td><td> " .$cuentapredial . "</td><td>$botonpredial</td><td><a href='$servidor/scripts/inmuebles/contratos/$accion/predial.pdf' target='_blank'><img src='images/icon_pdf.png' width='80'></a></td></tr>";
...
<div id="myModal2" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <iframe src="$servidor/scripts/inmuebles/datosajax/datos.php?idcontrato=<?php echo $accion ?>" width="100%" height="400" style="border:0px;"></iframe>
...
$("#correopredial").click(function(){
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Envio de Correos Contrato No. <?php echo $accion; ?></h4>
      </div>
      <div class="modal-body">
...
<script type="text/javascript">
	$("#verluz").click(function(){
		var service="luz";
		var contrat='<?php echo $accion; ?>';
document.getElementById("enlace").src="$servidor/scripts/inmuebles/datosajax/datos2.php?idcontrato="+contrat+"&servicio="+service;
	});
...
document.getElementById("enlace").src="$servidor/scripts/inmuebles/datosajax/datos2.php?idcontrato="+contrat+"&servicio="+service;
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Servicios del Contrato No. <?php echo $accion; ?></h4>
      </div>
      <div class="modal-body">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="form-group">
            ...
            <input type="text" class="form-control" id="contrato0" name="contrato" maxlength="30" value="<?php echo $accion; ?>" disabled> 
          </div>
           <div class="form-group">
...
$.ajax({
					...
					data: {servicio:servicioss,idcontrato:<?php echo $accion ?>},
					 beforeSend: function(data){
