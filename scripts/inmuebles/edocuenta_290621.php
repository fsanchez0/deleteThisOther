...
if ($accion){
	...
	$sql="select tipocobro, (b.cantidad * (1+ (b.iva)/100)) suma,(b.interes *100) elinteres from contrato c, cobros b, tipocobro t where c.idcontrato = b.idcontrato and b.idtipocobro = t.idtipocobro and b.idperiodo<>1 and c.idcontrato = $accion";
...
/*  fin subir pdf */	
	...
	if($usuarios==19||$usuarios==1||$usuarios==53||$usuarios==60||$usuarios==13||$usuarios==14||$usuarios==15||$usuarios==62||$usuarios==63||$usuarios==51||$usuarios==50||$usuarios==63||$usuarios==14||$usuarios==64||$usuarios==70||$usuarios==71){														
		...
		$botonexcel="<iframe src=\"http://rentascdmx.com/scripts/inmuebles/descargarEdoCuenta.php?idContrato=".$accion." style=\"border:0px; height:45px;width:600px;\"></iframe><button type=\"button\" id=\"btnexcel\" class=\"btn btn-success btn-sm \" data-toggle=\"modal\" data-target=\"#myModal\">Descargar Estado de Cuenta
		</button>";	
	}
	...
	while ($row = mysql_fetch_array($result))
	{
		...
		if($Datos==0)
		{
		    ...
		    $sqlref = "select * From contrato c, apartado a where c.idapartado = a.idapartado and c.idcontrato = " . $accion;
...
//****************************************	
	...
	$cabecera .= "<tr><td class='Cabecera'  width='180'>Servicio de Luz</td><td width='180'>" . $servicioluz. "</td><td>$botonluz</td><td><a href='http://rentascdmx.com//scripts/inmuebles/contratos/$accion/luz.pdf' target='_blank'><img src='images/icon_pdf.png' width='80'></a></td></tr>";
	$cabecera .= "<tr><td class='Cabecera'>Servicio de Agua</td><td> " . $servicioagua . "</td><td>$botonagua</td><td><a href='http://rentascdmx.com//scripts/inmuebles/contratos/$accion/agua.pdf' target='_blank'><img src='images/icon_pdf.png' width='80'></a></td></tr>";
	$cabecera .= "<tr><td class='Cabecera'>Servicio de Gas</td><td> " . $serviciogas . "</td><td>$botongas</td><td><a href='http://rentascdmx.com//scripts/inmuebles/contratos/$accion/gas.pdf' target='_blank'><img src='images/icon_pdf.png' width='80'></a></td></tr>";
	$cabecera .= "<tr><td class='Cabecera'>Pagos de Condominio</td><td> " . $serviciocondominio. "</td><td>$botoncondominio</td><td><a href='http://rentascdmx.com//scripts/inmuebles/contratos/$accion/condominio.pdf' target='_blank'><img src='images/icon_pdf.png' width='80'></a></td></tr>";
	$cabecera .= "<tr><td class='Cabecera'>Cuenta Predial</td><td> " .$cuentapredial . "</td><td>$botonpredial</td><td><a href='http://rentascdmx.com//scripts/inmuebles/contratos/$accion/predial.pdf' target='_blank'><img src='images/icon_pdf.png' width='80'></a></td></tr>";
...
<div id="myModal2" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <iframe src="http://rentascdmx.com//scripts/inmuebles/datosajax/datos.php?idcontrato=<?php echo $accion ?>" width="100%" height="400" style="border:0px;"></iframe>
