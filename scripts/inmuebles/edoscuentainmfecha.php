...
if($misesion->verifica_sesion()=="yes")
{
	...
	$todos="<input type='radio' name='opciontv' onClick = \"document.getElementById('patronb').value = '';document.getElementById('opciont').value=0;cargarSeccion('$ruta/listaedoscuentafecha.php', 'listadirectorio', 'patron=&opcion=' + document.getElementById('opciont').value)\"  $opttodos>Todos";
	$cerrados="<input type='radio' name='opciontv' onClick = \"document.getElementById('patronb').value = '';document.getElementById('opciont').value=1;cargarSeccion('$ruta/listaedoscuentafecha.php', 'listadirectorio', 'patron=&opcion=' + document.getElementById('opciont').value)\"  $optcerrados>Concluidos";
	$vigentes="<input type='radio' name='opciontv' onClick = \"document.getElementById('patronb').value = '';document.getElementById('opciont').value=2;cargarSeccion('$ruta/listaedoscuentafecha.php', 'listadirectorio', 'patron=&opcion=' + document.getElementById('opciont').value)\"  $optvigentes>Vigentes";
...
$html = <<<fin
<center>
<h1>Estados de cuenta de Contratos para Correcci&oacute;n de fechas de pago</h1>
<p>
$opciones<br>
Buscar: <input type="text" name="patronb" id="patronb" value="" onKeyUp="cargarSeccion('$ruta/listaedoscuentafecha.php', 'listadirectorio', 'patron=' + this.value + '&opcion=' + document.getElementById('opciont').value)"/>
</p>
