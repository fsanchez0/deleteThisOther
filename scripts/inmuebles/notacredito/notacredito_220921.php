...
//if($fechanaturalpago!=0)
				...
				$sql1 = "update historia set notacredito = true, aplicado=true, fechapago='" . $fechagenerado . "',  cantidad = cantidad + iva, notas = 'LIQUIDADO CON NOTA DE CREDITO', idmetodopago = $idmetodopago, parcialde = $parcialde,aprobado=1, notanc='".$valor1."' where idhistoria = " . $dhistoria[1];
				// Fin Cambio 08/09/21
