...
formulario1;
	...
	echo "<table border=\"1\"><tr><th>Id</th><th>Elemento</th><th>Expediente</th><th>Ubicaci&oacute;n</th><th>Aperturado</th><th>Descripci&oacute;n</th><th>Acciones</th></tr>";
	while($row = mysql_fetch_array($datos))
	{
		...
		$html .= "<input type=\"button\" value=\"Borrar\" onClick=\"if(confirm('&iquest;Est&aacute; seguro que desea borrar &eacute;ste elemento?')){cargarSeccion('$dirscript','contenido','accion=1&id=" .  $row["idexpediente"]  . "' )}\" $txtborrar>";
