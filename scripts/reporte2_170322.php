...
case 2://due�os 
	...
	if(empty($fechagen))
		$sql = "select * From cfdiedoduenio df, cfdipartidas pf, edoduenio e where df.idcfdiedoduenio = pf.idcfdiedoduenio and pf.idedoduenio = e.idedoduenio and e.reportado = 0 and df.idcfdiedoduenio = $id ";
	else
		$sql = "select * From cfdiedoduenio df, cfdipartidas pf, edoduenio e where df.idcfdiedoduenio = pf.idcfdiedoduenio and pf.idedoduenio = e.idedoduenio and e.fechagen = '$fechagen' and e.reportado = 1 and df.idcfdiedoduenio = $id ";
	// Fin Cambio 02/09/2021
