	...
	while($row = mysql_fetch_array($operacion))
	{
		...
		if($ccontrato!=$row["idasu"])
		{
			if($ccontrato!=0)
			{
				...
				echo "<table><tr><th align=\"rigth\">Total</th></tr>";
				echo "<tr><td align=\"rigth\"><strong>$ " . number_format($rentas,2) . "</strong></td></tr></table>";
				echo "</td></tr>";
		...
		echo "<tr><td>" . $row["fecha"] . "</td><td>" . $row["tipocargo"] . "</td><td>" . $row["edodesc"] . "</td><td align=\"right\">$ " . number_format($Pagado,2) . "</td></tr>\n";
