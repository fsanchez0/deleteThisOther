	...
	<td colspan="2">
		<fieldset >
			...
			<tr>
				...
				<td>
					<input type="text" name="txtfiltro" size="40" onKeyUp="cargarSeccion('$ruta/asuntobusqueda.php', 'busquedaasunto', 'filtro=' + this.value + '&opt=' + valoropt('filtro')  + '&opt2=' + valoropt('filtro2') )"  />
				</td>
				<td>
