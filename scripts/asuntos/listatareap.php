...
*/	
	...
	//inicia la variable que contendrá la consulta
	  ...
	  $sql="select t.idtarea as idtt,tarea, t.idasunto idt, t.notatarea as tdesc,terminado,vencimiento, count(idusurio), t.idusuario as idusuu from tarea t, tareausuario tu where terminado = 0 and t.idtarea=tu.idtarea and tu.idusurio=" . $misesion->usuario  . " $filtro group by t.idtarea, tarea, t.idasunto, t.notatarea, terminado, vencimiento,t.idusuario order by t.idtarea $orden";
	  ...
	  //$sql="select idtarea,tarea, t.idasunto idt,  t.notatarea as tdesc,terminado,vencimiento from tarea t where terminado = 0 $filtro order by idtarea $orden";
		...
		if(mysql_num_rows($datos)<=0)
		{
		      ...
		      $sql="select t.idtarea as idtt,tarea, t.idasunto idt, t.notatarea as tdesc,terminado,vencimiento, count(idusurio), t.idusuario as idusuu from tarea t, tareausuario tu where terminado = 0 and t.idtarea=tu.idtarea and tu.idusurio=" . $misesion->usuario  . " group by t.idtarea, tarea, t.idasunto, t.notatarea, terminado, vencimiento, t.idusuario order by t.idtarea";
	...
	<table border="0" width="700" $fondo >
 	<tr>
      		<td>
         		...
         		<b style="font-size:10;font-weight:bold;text-align:center;">(vence el $fechalimite $vencido)</b><br>
