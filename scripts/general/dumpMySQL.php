...
* Listo
* $tablas = array("usuario", "modulo", "submodulo", "inquilino", "inmueble", "contrato",  "accionc", "accionista", "actividadeconomica", "apartado", "apoderado", "archivo", "asunto", "calendario", "cambios", "categoria", "cfdilibre", "chat", "cita", "clientecbb", "clientelibre", "cobrorecibo", "contacto", "cuentaasociada", "cuentainmueble", "datoservicios","dgrupo", "directorio", "documento", "duenio", "dueniodistribucion", "duenioinmueble", "edoduenio", "envioclp", "enviomail", "estado", "estadocuenta", "expediente", "facturacbb", "facturacfdi", "fiador", "flibrecfdi", "folios", "folioscbb", "formato", "girocomercial", "grupoproyecto", "historiacfdi", "iguala", "importancia", "motivo", "pais", "mantenimiento", "mantenimientoseg", "margen", "metodopago", "periodo", "personal", "platica", "prioridad", "prioridadmant", "privilegio", "privilegiofile", "proyecto", "recibo", "reportemant", "rgrupo", "seguimiento", "seguimientocita", "seguimientomant", "subtareas", "tarea", "tareausuario", "tipoalerta", "tipocargo", "tipocobro", "tipocontacto","tipocontrato", "tipocuentaasociada", "tipocuentai", "tipoformato", "tipoinmueble", "tipopersona", "tipopersonal", "tiposervicio", "traspasodepara", "tseguimiento");
"historia"
"cfdipartidas"
"archivoseguimiento"
